...
byte pinLocation(byte pinID) {
  byte pinMap[9][2] = {
  // v0, v1 ...
    {7,  7},  // RED_LED     any digital pin
    {2,  2},  // YELLOW_LED  any digital pin
    {4,  4},  // GREEN_LED   any digital pin
    {3,  3},  // ESC_PPM     any digital pin
    {6,  6},  // ESC2_PPM    any digital pin
    {0,  7},  // ESC3_PPM    any digital pin
    {0,  8},  // ESC4_PPM    any digital pin
    {A4, A4},  // BUTTON1     any digital pin
    {A5, A5}   // BUTTON2     any digital pin
  };
